  ...
  return (
    <VStack bg="blue.900" flex={1} px={6} py={60}>
      ...
      <Text color="blue.100" fontSize="lg" my={8} fontWeight="regular">
        Por favor, preencha todas as entradas para criar um novo conta.
      </Text>

      <Box bg="blue.800" px={4} py={4} rounded="lg">
        <Input label="Login" placeholder="Digite seu login" />

        <Input label="Telefone" placeholder="Digite seu login" />
      ...
      <VStack mt={16}>
        ...
        <HStack alignItems="center" justifyContent="center">
          ...
          <Button label="Fazer Login" variant="outline" />
        </HStack>
      </VStack>
      ...
      <VStack>
        <HStack alignItems="center" justifyContent="space-between">
          ...
          <Text fontSize={14} color="blue.100" fontWeight="regular">
            Ou entre com
          </Text>
          <Divider w="93" bg="blue.100" />
        </HStack>
        ...
        <HStack alignItems="center" justifyContent="center" my={17}>
          ...
          <IconButton icon={FacebookSvg} mx={4} />
          <IconButton icon={LinkedinSvg} />
        </HStack>
      </VStack>
    </VStack>
  );
