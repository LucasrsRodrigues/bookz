...
export function Verification() {
  return (
    <VStack bg="blue.900" flex={1} paddingTop={60}>
      <VStack px={6}>
        <IconButton icon={ArrowLeftIcon} mb={8} />
        ...
        <Text color="blue.100" fontSize={18}>
          Um código de 4 dígitos foi enviado para +101234567899
        </Text>
        ...
        <HStack justifyContent="space-around" my={58}>
          ...
          >
            <Text fontSize={24} color="blue.100" fontWeight="medium">
              4
            </Text>
          </Box>
      ...
      >
        ...
        <HStack px={3}>
          <NBButton mb={3} flex={1} h={58} bg="blue.700">
            <Text color="blue.100" fontSize={24} fontWeight="bold">
              1
            </Text>
          </NBButton>
        ...
        <HStack px={3}>
          <NBButton mb={3} flex={1} h={58} bg="blue.700"></NBButton>
          <NBButton mb={3} mx={3} flex={1} h={58} bg="blue.700">
            <Text color="blue.100" fontSize={24} fontWeight="bold">
              0
            </Text>
